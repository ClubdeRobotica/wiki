...
||<tablewidth="100%" tablestyle="text-align:center"50%  style="border:medium none; ;text-align:center">{{attachment:stellaris.jpg|Stellaris Launchpad|width="300"}}||<tablewidth="100%" tablestyle="text-align:center"50%  style="border:medium none; ;text-align:center">{{attachment:StellarisLaunchPadreducida.png|PinOut Stellaris|width="550"}}||
